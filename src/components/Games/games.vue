<template>
  <div id="games">
    ...
    <div id="gamesListContainer" v-show="showMinesweeper || showTetris" class="inline">
      <ul>
        <li id="gamesLink" v-on:click="showMinesweeper = false; showTetris = false;">
          <a>Games</a>
        </li>
      </ul>
      ...
      <ul>
        <li id="minesweeperActive" v-on:click="showMinesweeper = true; showTetris = false;">
          <a>Minesweeper</a>
        </li>
        <li id="tetrisActive" v-on:click="showTetris = true; showMinesweeper = false;">
          <a>Tetris</a>
        </li>
      </ul>
    </div>
      ...
      <ul style="padding-top: 20px">
        ...
        <div style="display: flex; padding-bottom: 25px">
          <p class="description">
            ...
            Built with Svelte and Node.js serverless functions, this project leverages AWS Amplify and DynamoDB for seamless
            hosting and data management.
          </p>
          <img
            v-on:click="showTetris = true; showMinesweeper = false;"
...
<style scoped>
  ...
  .play-link:hover, .github-link:hover {
